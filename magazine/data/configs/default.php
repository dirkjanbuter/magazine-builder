...
class config 
{
	...
	public static $noReplyEmail = "noreply@dirkjanbuter.com";
	public static $adminEmail = "djbuter@gmail.com";
	public static $magazineHome = "/";
	public static $discordInvitationLink = 'https://discord.gg/hs6C6Xj7WR';
}
